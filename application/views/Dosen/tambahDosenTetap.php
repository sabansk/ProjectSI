...
<div class="container-fluid">
  <div class="p-3">
    <div class="text-left">
      <h2 class="h2 text-gray-900 mb-1">Tambah Data Dosen Tetap</h2>
      <div class="text-center p-t-10">
        <hr class="sidebar-divider">
      </div>
    </div>
    <form class="form-horizontal" method="post" action="<?= site_url('C_DosenTetap/tambahDosenTetap_aksi') ?>" enctype="multipart/form-data">
      ...
      <div class="form-group">
        <input type="text" class="form-control" name="gelardepan" placeholder="Gelar Sarjana Depan. Contoh: Drs." value="<?= set_value('gelardepan') ?>">
        <?= form_error('gelardepan', '<small class="text-danger pl-3">', '</small>'); ?>
      </div>
      <div class="form-group">
        <input type="text" class="form-control" name="gelarbelakang" placeholder="Gelar Sarjana Belakang. Contoh: S.Si, S.Kom." value="<?= set_value('gelarbelakang') ?>">
        <?= form_error('gelarbelakang', '<small class="text-danger pl-3">', '</small>'); ?>
      </div>
      <div class="form-group">
        <input type="text" class="form-control" name="pendidikan1" placeholder="Tempat Pelaksanaan Pendidikan S1" value="<?= set_value('pendidikan1') ?>">
        <?= form_error('pendidikan1', '<small class="text-danger pl-3">', '</small>'); ?>
      </div>
      <div class="form-group">
        <input type="text" class="form-control" name="pendidikan2" placeholder="Tempat Pelaksanaan Pendidikan S2" value="<?= set_value('pendidikan2') ?>">
        <?= form_error('pendidikan2', '<small class="text-danger pl-3">', '</small>'); ?>
      </div>
      <div class="form-group">
        <input type="text" class="form-control" name="pendidikan3" placeholder="Tempat Pelaksanaan Pendidikan S3" value="<?= set_value('pendidikan3') ?>">
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        Lampir surat tanda bukti: <input type="file" class="form-control" name="suratbukti"/>
      </div>
