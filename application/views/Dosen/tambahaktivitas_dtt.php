...
<div class="container-fluid">
  <div class="p-3">
    <div class="text-left">
      <h2 class="h2 text-gray-900 mb-1">Tambah Aktivitas Dosen Tidak Tetap</h2>
      <div class="text-center p-t-10">
        <hr class="sidebar-divider">
      </div>
    </div>
    <form class="form-horizontal" method="post" action="<?= site_url('C_AktivitasDTT/tambahaktivitas_dtt_aksi') ?>">
      <div class="form-group">
        <select class="form-control" style="width:100%" name="nama" required>
          <option selected disabled>Pilih Nama Dosen Tidak Tetap</option>
          <?php foreach ($dosentdktetap as $u) { ?>
